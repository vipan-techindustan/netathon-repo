...
export default function PaginatationTable({editHandler, deleteHandle}) {
    return (
        <div>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div className='flex flex-wrap gap-3'>
                                    <AiFillDelete className="cursor-pointer" onClick={()=>deleteHandle(true)} size={20}  />
                                    <MdModeEditOutline className="cursor-pointer" size={20}  onClick={()=>editHandler(true)}/>
                                </div>
                            </td>
                        </tr>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
