...
export default function LoadingButton({ isLoading , children ,type='button',title="Loading" }) {
    return (
        <div>
            <button disabled={isLoading} type={type} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
