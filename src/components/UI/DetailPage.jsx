    ...
    return (
        <div>
            <div class="flex flex-col justify-center items-center h-[100vh]">
                ...
                <img src="https://images.unsplash.com/photo-1522199755839-a2bacb67c546?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDR8fHdlYnNpdGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="" className="h-[300px] object-cover w-full p-0" />
                    ...
                    <div class="grid grid-cols-2 gap-4 px-2 w-full">
                        ...
                        <div class="flex flex-col justify-center rounded-2xl bg-white shadow-md bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
